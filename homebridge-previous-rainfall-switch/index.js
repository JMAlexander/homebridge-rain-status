...
class PreviousRainfallSwitchPlatform {
  constructor(log, config, api) {
    ...
    if (!config) {
      log.warn('No configuration found for PreviousRainfallSwitch');
      return;
    }

    this.name = config.name || 'Previous Rainfall Switch';
  ...
  createSwitch() {
    ...
    this.api.registerPlatformAccessories('homebridge-previous-rainfall-switch', 'PreviousRainfallSwitch', [accessory]);
...
module.exports = (api) => {
  api.registerPlatform('homebridge-previous-rainfall-switch', 'PreviousRainfallSwitch', PreviousRainfallSwitchPlatform);
}; 
